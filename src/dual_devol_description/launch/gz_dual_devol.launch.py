...
def generate_launch_description():
    # Define file names
    urdf_package = "dual_devol_description"
    moveit_package = "dual_devol_moveit_config"
    project_gz_package_name: str = "devol_gazebo"
    gz_package_name: str = "ros_gz_sim"

    gz_launch_filename: str = "gz_sim.launch.py"
    urdf_filename = "dual_devol.urdf.xacro"
    rviz_config_filename = "dual_devol.rviz"
    ...
    moveit_config = (
        MoveItConfigsBuilder(robot_name="dual_devol", package_name=moveit_package)
        .to_moveit_configs()
    )
    ...
    gz_spawn_entity_cmd: Node = Node(
        ...
        executable="create",
        output="screen",
        arguments=["-topic", 'robot_description', '-name', 'dual_devol', '-x', '0', '-y', '0', '-z', '0.3', '-allow_renaming', 'true'],
    ...
    start_gz_bridge_cmd: Node = Node(
        ...
        arguments=["/clock@rosgraph_msgs/msg/Clock[gz.msgs.Clock",
                   "/model/artemis_devol/color_raw@sensor_msgs/msg/Image[gz.msgs.Image",
                   "/model/artemis_devol/color_info@sensor_msgs/msg/CameraInfo[gz.msgs.CameraInfo",
                   "/model/artemis_devol/depth_raw@sensor_msgs/msg/Image[gz.msgs.Image",
                   "/model/artemis_devol/depth_info@sensor_msgs/msg/CameraInfo[gz.msgs.CameraInfo",
                   '/model/artemis_devol_drive/cmd_vel@geometry_msgs/msg/Twist@gz.msgs.Twist',
                   '/model/artemis_devol_drive/odometry@nav_msgs/msg/Odometry@gz.msgs.Odometry',
                   "/model/apollo_devol/color_raw@sensor_msgs/msg/Image[gz.msgs.Image",
                   "/model/apollo_devol/color_info@sensor_msgs/msg/CameraInfo[gz.msgs.CameraInfo",
                   "/model/apollo_devol/depth_raw@sensor_msgs/msg/Image[gz.msgs.Image",
                   "/model/apollo_devol/depth_info@sensor_msgs/msg/CameraInfo[gz.msgs.CameraInfo",
                   '/model/apollo_devol_drive/cmd_vel@geometry_msgs/msg/Twist@gz.msgs.Twist',
                   '/model/apollo_devol_drive/odometry@nav_msgs/msg/Odometry@gz.msgs.Odometry'
                   ],
        output='screen'
    )
