...
ARGUMENTS = [
    DeclareLaunchArgument('name', default_value='dual_devol',
                          description=''),
]
...
def generate_launch_description():
    ...
    # Spawn UR controller
    controllers = ["apollo_ur_manipulator_controller", "apollo_hand_controller",
                   "artemis_ur_manipulator_controller", "artemis_hand_controller"]
    spawn_controller_cmds: List[Node] = []
    for controller in controllers:
        spawn_controller_cmds.append(Node(
            package="controller_manager",
            executable="spawner",
    ...
    for spawn_controller_cmd in spawn_controller_cmds:
        ld.add_action(spawn_controller_cmd)
    ld.add_action(RegisterEventHandler(
        event_handler=OnProcessExit(
            target_action=spawn_controller_cmds[0],
